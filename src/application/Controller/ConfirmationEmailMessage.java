...
import javafx.stage.StageStyle;
 ...
 public class ConfirmationEmailMessage extends Stage {
            Stage owner;
            Stage stage;
            BorderPane root;
            static boolean postStatus;
            boolean chkClose = false;
            public ConfirmationEmailMessage( Stage owner, String title){
            root = new BorderPane();
            stage = this;
            this.owner = owner;
            ...
            buttonPane.getChildren().addAll(yes);
        ...
        //   stage.show();
              ...
              new ConfirmationEmailMessage(owner, title);
