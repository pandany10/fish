...
public class OrdersMemoController extends Menu implements Initializable {
...
;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		twResultSearch.setVisible(false);
		chkPackingList.setVisible(false);
		btnPackingList.setVisible(false);
		fSearchP.setValue(false);
		txtKeySearch.setVisible(false);
	...
	public void initViewOrders() {
     ...
     Callback<TableColumn<OrderModel, Boolean>, TableCell<OrderModel, Boolean>> booleanCellFactoryIssued = 
		...
		order_id.setCellValueFactory(new PropertyValueFactory<>("order_idc"));
...
/*	public void showDetail(int orderId) throws ClassNotFoundException, SQLException {
	...
	public void showDetail(OrderDetailModel orderDetail) {
		...
		List<ProductModel> lstProducts = orderDetail.getLstProduct();
		List<ProductModel> lstProduct =   new ArrayList<>(); 

		for (ProductModel productModel : lstProducts) {
		   if(productModel.getFishdie() == true){
