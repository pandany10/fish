...
public class OrdersExpressController extends Menu implements Initializable {
...
/*	public void showDetail(int orderId) throws ClassNotFoundException, SQLException {
   ...
   public void explanCustomer() throws IOException {   
		...
		if (pos.getRow() < twSearchCus.getItems().size()) {
			...
			String cusIds = c.getCustomerID();
			gotoOrdersExpressStore(cusIds);
