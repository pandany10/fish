...
public class OrdersMeno1Controller extends Menu implements Initializable {
...
/*	public void showDetail(int orderId) throws ClassNotFoundException, SQLException {
    ...
    public void loadCreaditMemos(Integer in) throws IOException{
   	 Stage stage = new Stage();
        stage.setTitle("Orders "+in);
        stage.getIcons().add(new Image("file:resources/images/icon.png"));
        FXMLLoader myLoader  = new  FXMLLoader(getClass().getResource("/application/View/OrdersCreditmemos2.fxml"));
        Pane myPane = (Pane)myLoader.load();
        
        OrdersMemo2Controller controller = (OrdersMemo2Controller) myLoader.getController();
 	    controller.setPrevStage(stage);
       Scene scene = new Scene(myPane);
        stage.setScene(scene);
        controller.setOrderId(in);
        prevStage.close();
